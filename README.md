...
- Worked with IOF Dev Team ([Main BFF architecture design and implementation](https://github.com/telus/iof-frontdoor-bff/graphs/contributors)) 2021-2023
- Worked with HRT tool/SOVC (Java/Angular heavy SPA for Agents, code might be lost in the TFS migration?) 2016-2020 
